var ObstaculoHielo = cc.Class.extend({
    space:null,
    sprite:null,
    shape:null,
    layer:null,
ctor:function (space, posicion, layer) {
    ...
    this.sprite = new cc.PhysicsSprite("#ObstaculoHielo.png");
    ...
    this.shape.setCollisionType(tipoObstaculoHielo);
